...
兩班之中**實際上只有一班會真的抓**：重抓週期 20 小時比兩班的間隔 12 小時長，
所以先跑的那班抓完之後，後跑的那班會發現每一門都還新鮮，抓 0 頁就結束。
後面那班的用處是**備援** —— 前一班若遇上學校斷線整批失敗，當天稍後補得回來，
不必等到隔天。（2026-09-04 就發生過：學校清晨掛了一小時，那天的大綱沒更新。）
...
- `syllabus.json` 記著每門課上次抓的時間，重抓週期預設 **20 小時**
  （`--syllabus-refresh-after`）—— 必須小於 24，否則昨天抓過的今天全被跳過。
  想讓一天兩班都真的全跑，填小於 12
...
每天的總請求數約 4,750 次（4 小時排程 6 × 355，大綱那支的 2,264，加備援那班空跑的 355），
...
| `--syllabus-refresh-after H` | 同一門課的大綱隔多久重抓，預設 `20` 小時（配合每天全跑一輪） |
